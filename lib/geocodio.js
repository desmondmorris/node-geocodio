 ...
 * @param  {String|Array|Object} address, array of addresses, or object with params such as fields: http://geocod.io/docs/#toc_17
...
Geocodio.prototype.geocode = function(address, cb) {
  ...
  if (typeof address === 'string') {
    query = {q: address};
  } else if (toString.call(address) == '[object Array]') {
    method = "POST";
  }
